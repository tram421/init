...
{
  var menuToggle = $('#nav__mobile');
  var menuFull = $('.nav__list');
...
{
  var imgProducts = $$('.product__content');
  var buttonViewProduct = $('.jsView-detail');

  var _iterator = _createForOfIteratorHelper(imgProducts),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var imgProduct = _step.value;
...
module.exports = __webpack_require__(/*! D:\laragon\www\ck\resources\js\main.js */"./resources/js/main.js");
