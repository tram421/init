        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col col-12 col-md-6 col-lg-6 price">
                    ...
                    <input type="number" name="price" style="width: 100%" onkeyup="showPrice()"
                           class="priceInput"
                           value='@if(isset($data['price'])){{$data['price']}}@else{{0}}@endif'>
                    <span class="display_price"></span></Br>
                    <span class="display_price_text">(Bằng chữ: @if(isset($data['price'])){{readNum($data['price'])}}@else{{0}}@endif)</span>
                </div>
                <div class="col col-12 col-md-6 col-lg-6 price">
                    <label style="color:darkred">Giá giảm</label>
                    <input type="number" name="price_sale" style="width: 100%"
                           onkeyup="showPrice()" class="priceInput"
                           value='@if(isset($data['price_sale'])){{$data['price_sale']}}@else{{0}}@endif'>
                    <span class="display_price"></span></Br>
                    <span class="display_price_text">(Bằng chữ: @if(isset($data['price_sale'])){{readNum($data['price_sale'])}}@else{{0}}@endif)</span>
                </div>
            </div>
            <div class="row">
                <div class="form-group">
